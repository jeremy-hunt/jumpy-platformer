...
sprites.onOverlap(SpriteKind.Bumper, SpriteKind.Projectile, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Flier, SpriteKind.Projectile, function (sprite, otherSprite) {
    sprites.destroy(sprite)
    sprites.destroy(otherSprite)
})
function spawnGoals () {
